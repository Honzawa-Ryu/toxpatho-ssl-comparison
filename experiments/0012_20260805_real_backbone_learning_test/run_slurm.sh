#!/bin/bash
#SBATCH --job-name=0012_20260805_real_backbone_learning_test
#SBATCH --partition=x-large-andre01
#SBATCH --output=/workspace/andre01/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0012_20260805_real_backbone_learning_test/%j_0012_20260805_real_backbone_learning_test.out
#SBATCH --error=/workspace/andre01/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0012_20260805_real_backbone_learning_test/%j_0012_20260805_real_backbone_learning_test.out
...
# #SBATCH --output=/workspace/andre01/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0012_20260805_real_backbone_learning_test/%A_%a_0012_20260805_real_backbone_learning_test.out
# #SBATCH --error=/workspace/andre01/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0012_20260805_real_backbone_learning_test/%A_%a_0012_20260805_real_backbone_learning_test.out
# #SBATCH --array=0-N
#
...
export EXP_NAME="0012_20260805_real_backbone_learning_test"
