#!/bin/bash
#SBATCH --job-name=0007_20260805_blur_heatmaps
#SBATCH --partition=small-creator
#SBATCH --output=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0007_20260805_blur_heatmaps/%j_0007_20260805_blur_heatmaps.out
#SBATCH --error=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0007_20260805_blur_heatmaps/%j_0007_20260805_blur_heatmaps.out
...
# #SBATCH --output=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0007_20260805_blur_heatmaps/%A_%a_0007_20260805_blur_heatmaps.out
# #SBATCH --error=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0007_20260805_blur_heatmaps/%A_%a_0007_20260805_blur_heatmaps.out
# #SBATCH --array=0-N
#
...
export EXP_NAME="0007_20260805_blur_heatmaps"
