#!/bin/bash
#SBATCH --job-name=0010_20260805_ddp_test
#SBATCH --partition=x-large-andre01
#SBATCH --output=/workspace/andre01/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0010_20260805_ddp_test/%j_0010_20260805_ddp_test.out
#SBATCH --error=/workspace/andre01/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0010_20260805_ddp_test/%j_0010_20260805_ddp_test.out
...
# #SBATCH --output=/workspace/andre01/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0010_20260805_ddp_test/%A_%a_0010_20260805_ddp_test.out
# #SBATCH --error=/workspace/andre01/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0010_20260805_ddp_test/%A_%a_0010_20260805_ddp_test.out
# #SBATCH --array=0-N
#
...
export EXP_NAME="0010_20260805_ddp_test"
