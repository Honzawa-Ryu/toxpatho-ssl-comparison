#!/bin/bash
#SBATCH --job-name=0003_20260803_blur_test
#SBATCH --partition=small-creator
#SBATCH --output=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0003_20260803_blur_test/%j_0003_20260803_blur_test.out
#SBATCH --error=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0003_20260803_blur_test/%j_0003_20260803_blur_test.out
...
# #SBATCH --output=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0003_20260803_blur_test/%A_%a_0003_20260803_blur_test.out
# #SBATCH --error=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0003_20260803_blur_test/%A_%a_0003_20260803_blur_test.out
# #SBATCH --array=0-N
#
...
export EXP_NAME="0003_20260803_blur_test"
