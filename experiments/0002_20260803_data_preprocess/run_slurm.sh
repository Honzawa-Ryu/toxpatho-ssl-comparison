#!/bin/bash
#SBATCH --job-name=0002_20260803_data_preprocess
#SBATCH --partition=x-large-creator
#SBATCH --output=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0002_20260803_data_preprocess/%j_0002_20260803_data_preprocess.out
#SBATCH --error=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0002_20260803_data_preprocess/%j_0002_20260803_data_preprocess.out
...
# #SBATCH --output=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0002_20260803_data_preprocess/%A_%a_0002_20260803_data_preprocess.out
# #SBATCH --error=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0002_20260803_data_preprocess/%A_%a_0002_20260803_data_preprocess.out
# #SBATCH --array=0-N
#
...
export EXP_NAME="0002_20260803_data_preprocess"
...
# この実験では raw_slide のみが読み取り専用入力。trident_processed 配下の
# coords h5 は experiment.py がその場で追記書き込みする対象なので、
# ここに含めないこと（scratch に書いた追記結果が NFS へ戻らず消える）。
# 例:
# DATA_SUBDIRS=(
#     "raw_slide"
# )
