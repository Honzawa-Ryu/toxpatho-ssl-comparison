#!/bin/bash
#SBATCH --job-name=0027_20260904_repr_dino_epoch_compare
#SBATCH --partition=small-andre01
#SBATCH --output=/workspace/andre01/honzawa/02-playground/toxpatho-ssl-comparison/logs/0027_20260904_repr_dino_epoch_compare/%j_0027_20260904_repr_dino_epoch_compare.out
#SBATCH --error=/workspace/andre01/honzawa/02-playground/toxpatho-ssl-comparison/logs/0027_20260904_repr_dino_epoch_compare/%j_0027_20260904_repr_dino_epoch_compare.out
...
# #SBATCH --output=/workspace/andre01/honzawa/02-playground/toxpatho-ssl-comparison/logs/0027_20260904_repr_dino_epoch_compare/%A_%a_0027_20260904_repr_dino_epoch_compare.out
# #SBATCH --error=/workspace/andre01/honzawa/02-playground/toxpatho-ssl-comparison/logs/0027_20260904_repr_dino_epoch_compare/%A_%a_0027_20260904_repr_dino_epoch_compare.out
# #SBATCH --array=0-N
#
...
export PROJECT_ROOT="/workspace/andre01/honzawa/02-playground/toxpatho-ssl-comparison"
export EXP_NAME="0027_20260904_repr_dino_epoch_compare"
