#!/bin/bash
#SBATCH --job-name=20260507_180303_baseline
#SBATCH --partition=small-andre01
#SBATCH --output=outputs/20260507_180303_baseline/%j_slurm.out
#SBATCH --error=outputs/20260507_180303_baseline/%j_slurm.out
#SBATCH --nodes=1
#SBATCH --gpus=1
...
export EXP_NAME="20260507_180303_baseline"
ENV_FILE="${PROJECT_ROOT}/.env"
WORKSPACE_OUTPUT_DIR="${PROJECT_ROOT}/outputs/20260507_180303_baseline"
...
apptainer exec --nv --bind "${LOCAL_SSD_DIR}" "${PROJECT_ROOT}/env/env.sif" bash -c "
    ...
    python ${PROJECT_ROOT}/experiments/20260507_180303_baseline/experiment.py
"
