#!/bin/bash
#SBATCH --job-name=0005_20260805_compute_blur_new_slides
#SBATCH --partition=small-creator
#SBATCH --output=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0005_20260805_compute_blur_new_slides/%j_0005_20260805_compute_blur_new_slides.out
#SBATCH --error=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0005_20260805_compute_blur_new_slides/%j_0005_20260805_compute_blur_new_slides.out
...
# #SBATCH --output=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0005_20260805_compute_blur_new_slides/%A_%a_0005_20260805_compute_blur_new_slides.out
# #SBATCH --error=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0005_20260805_compute_blur_new_slides/%A_%a_0005_20260805_compute_blur_new_slides.out
# #SBATCH --array=0-N
#
...
export EXP_NAME="0005_20260805_compute_blur_new_slides"
