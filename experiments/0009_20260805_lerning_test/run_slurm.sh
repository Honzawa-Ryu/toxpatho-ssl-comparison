#!/bin/bash
#SBATCH --job-name=0009_20260805_lerning_test
#SBATCH --partition=x-large-andre01
#SBATCH --output=/workspace/andre01/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0009_20260805_lerning_test/%j_0009_20260805_lerning_test.out
#SBATCH --error=/workspace/andre01/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0009_20260805_lerning_test/%j_0009_20260805_lerning_test.out
...
# #SBATCH --output=/workspace/andre01/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0009_20260805_lerning_test/%A_%a_0009_20260805_lerning_test.out
# #SBATCH --error=/workspace/andre01/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0009_20260805_lerning_test/%A_%a_0009_20260805_lerning_test.out
# #SBATCH --array=0-N
#
...
export EXP_NAME="0009_20260805_lerning_test"
