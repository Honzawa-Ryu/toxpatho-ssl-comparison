#!/bin/bash
#SBATCH --job-name=0009_20260801_blur_qc_sample_batch
#SBATCH --partition=x-large-andre01
#SBATCH --output=/workspace/logs/0009_20260801_blur_qc_sample_batch/%A_%a_0009_20260801_blur_qc_sample_batch.out
#SBATCH --error=/workspace/logs/0009_20260801_blur_qc_sample_batch/%A_%a_0009_20260801_blur_qc_sample_batch.out
#SBATCH --array=0-19
...
# --time/--array/num_chunksは実測を見てから調整すること。
# 投入前に必ずdata/blur_qc/patches/の想定容量(約140GiB)を利用者に確認すること。
...
export EXP_NAME="0009_20260801_blur_qc_sample_batch"
...
# data/全量(WSI 998枚 + trident_processed)を20並列で毎回コピーする無駄を避けて
# NFSを直接読む。
