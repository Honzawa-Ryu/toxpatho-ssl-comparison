#!/bin/bash
#SBATCH --job-name=20260630_000003_tggate_densenet121_bt_aug_std
#SBATCH --partition=x-large-andre01
#SBATCH --time=48:00:00
#SBATCH --output=outputs/20260630_000003_tggate_densenet121_bt_aug_std/%j_slurm.out
#SBATCH --error=outputs/20260630_000003_tggate_densenet121_bt_aug_std/%j_slurm.out
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G

# Backbone: DenseNet121 | SSL: BarlowTwins | Aug: standard | Epoch: 100
USE_LOCAL_SSD_INPUT=0
USE_LOCAL_SSD_OUTPUT=0
export DEPENDENT_EXPS=""

export PROJECT_ROOT="/workspace/andre01/honzawa/wsi-ad"
export EXP_NAME="20260630_000003_tggate_densenet121_bt_aug_std"
