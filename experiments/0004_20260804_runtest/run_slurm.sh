#!/bin/bash
#SBATCH --job-name=0004_20260804_runtest
#SBATCH --partition=small-creator
#SBATCH --output=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0004_20260804_runtest/%j_0004_20260804_runtest.out
#SBATCH --error=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0004_20260804_runtest/%j_0004_20260804_runtest.out
...
# #SBATCH --output=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0004_20260804_runtest/%A_%a_0004_20260804_runtest.out
# #SBATCH --error=/workspace/filesrv02/honzawa/01-toxpatho/toxpatho-ssl-comparison/logs/0004_20260804_runtest/%A_%a_0004_20260804_runtest.out
# #SBATCH --array=0-N
#
...
export EXP_NAME="0004_20260804_runtest"
