#!/bin/bash
#SBATCH --job-name=20260613_133705_tggate_resnet18_barlowtwins_layerwise
#SBATCH --partition=x-large-andre01
#SBATCH --time=12:00:00
#SBATCH --output=outputs/20260613_133705_tggate_resnet18_barlowtwins_layerwise/%j_slurm.out
#SBATCH --error=outputs/20260613_133705_tggate_resnet18_barlowtwins_layerwise/%j_slurm.out
#SBATCH --nodes=1
#SBATCH --gpus=1
...
export EXP_NAME="20260613_133705_tggate_resnet18_barlowtwins_layerwise"
ENV_FILE="${PROJECT_ROOT}/.env"
WORKSPACE_OUTPUT_DIR="${PROJECT_ROOT}/outputs/20260613_133705_tggate_resnet18_barlowtwins_layerwise"
...
echo "Batch Size: 256"
echo "Epochs: 10"
echo "Layer-wise LR: True"
echo "Backbone LR Ratio: 0.1"
echo "========================================="
