#!/bin/bash
#SBATCH --job-name=20260630_000004_tggate_resnet18_bt_aug_weak
#SBATCH --partition=x-large-andre01
#SBATCH --time=48:00:00
#SBATCH --output=outputs/20260630_000004_tggate_resnet18_bt_aug_weak/%j_slurm.out
#SBATCH --error=outputs/20260630_000004_tggate_resnet18_bt_aug_weak/%j_slurm.out
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G

# Backbone: ResNet18 | SSL: BarlowTwins | Aug: weak | Epoch: 100
# Weak aug: pathology staining color is diagnostically meaningful -> reduce color jitter
USE_LOCAL_SSD_INPUT=0
USE_LOCAL_SSD_OUTPUT=0
export DEPENDENT_EXPS=""

export PROJECT_ROOT="/workspace/andre01/honzawa/wsi-ad"
export EXP_NAME="20260630_000004_tggate_resnet18_bt_aug_weak"
...
echo "Aug:         weak (color=0.2, blur=0.1, solar=0.0)"
echo "Batch size:  256"
echo "Epochs:      100"
echo "========================================="
