#!/bin/bash
#SBATCH --job-name=20260711_000003_tggate_vitb16_simsiam
#SBATCH --partition=x-large-andre01
#SBATCH --time=72:00:00
#SBATCH --output=outputs/20260711_000003_tggate_vitb16_simsiam/%j_slurm.out
#SBATCH --error=outputs/20260711_000003_tggate_vitb16_simsiam/%j_slurm.out
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=8
#SBATCH --mem=48G

# Backbone: ViT-B/16 | SSL: SimSiam | Batch: 128
# SimSiam on ViT-B/16 -- completes the backbone-matched 4-method set on ViT
# (MAE / DINO / BarlowTwins / SimSiam all ViT) to isolate the method effect.
# weight_decay 0.05 is important: the ResNet SimSiam collapsed at wd=0; ViT-style
# wd both regularizes ViT-from-scratch and supplies SimSiam's needed decay.
# lr 1.5e-4, warmup 15, 2 views, batch 128. Early stopping (patience 15).
USE_LOCAL_SSD_INPUT=0
USE_LOCAL_SSD_OUTPUT=0
export DEPENDENT_EXPS=""

export PROJECT_ROOT="/workspace/andre01/honzawa/wsi-ad"
export EXP_NAME="20260711_000003_tggate_vitb16_simsiam"
