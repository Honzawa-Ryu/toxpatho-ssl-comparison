...
最終更新: 2026-09-17（セッション11: **exp 0028 = peak lr 半減ラン**と、**所見ラベルを使った
epoch 別下流評価**のスクリプトを実装。どちらも未実行。セッション10 の「ep85 の下流評価」は
実際にはラベル不要の幾何評価だったので、その訂正を含む）
...
## 🎯 exp 0028: peak lr 半減（2026-09-17, セッション11, job 3382307）— 投入済み・結果待ち
