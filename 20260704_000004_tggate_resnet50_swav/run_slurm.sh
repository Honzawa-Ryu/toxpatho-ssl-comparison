#!/bin/bash
#SBATCH --job-name=20260704_000004_tggate_resnet50_swav
#SBATCH --partition=x-large-andre01
#SBATCH --time=72:00:00
#SBATCH --output=outputs/20260704_000004_tggate_resnet50_swav/%j_slurm.out
#SBATCH --error=outputs/20260704_000004_tggate_resnet50_swav/%j_slurm.out
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G

# Backbone: ResNet50 | SSL: SwAV | Batch: 256 | Epoch: 100
# SwAV optimized to use 2 crops (multi=False) matching SimCLR/SimSiam/BarlowTwins
# allowing batch_size=256 and batched GPU forward pass.
USE_LOCAL_SSD_INPUT=0
USE_LOCAL_SSD_OUTPUT=0
export DEPENDENT_EXPS=""

export PROJECT_ROOT="/workspace/andre01/honzawa/wsi-ad"
export EXP_NAME="20260704_000004_tggate_resnet50_swav"
...
echo "SSL:         SwAV (2-crop optimized)"
echo "Batch size:  256"
echo "Epochs:      100"
echo "========================================="
