#!/bin/bash
#SBATCH --job-name=20260704_000002_tggate_resnet50_simsiam
#SBATCH --partition=x-large-andre01
#SBATCH --time=72:00:00
#SBATCH --output=outputs/20260704_000002_tggate_resnet50_simsiam/%j_slurm.out
#SBATCH --error=outputs/20260704_000002_tggate_resnet50_simsiam/%j_slurm.out
#SBATCH --nodes=1
#SBATCH --gpus=1
...
export EXP_NAME="20260704_000002_tggate_resnet50_simsiam"
...
apptainer exec --nv --bind "${LOCAL_SSD_DIR}" "${PROJECT_ROOT}/env/env.sif" bash -c "
    ...
    python ${PROJECT_ROOT}/scripts/train/train_tggate.py \
        --note ssl_bench_simsiam_resnet50 \
