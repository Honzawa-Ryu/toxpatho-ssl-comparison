#!/bin/bash
#SBATCH --job-name=0001_20260729_repr_extract_embeddings
#SBATCH --partition=x-large-andre01
#SBATCH --output=/workspace/filesrv02/honzawa/wsi-ad/logs/0001_20260729_repr_extract_embeddings/%j_0001_20260729_repr_extract_embeddings.out
#SBATCH --error=/workspace/filesrv02/honzawa/wsi-ad/logs/0001_20260729_repr_extract_embeddings/%j_0001_20260729_repr_extract_embeddings.out
...
# Representation analysis phase 1/2: 共有パッチ集合を各手法で埋め込む。
#
...
export EXP_NAME="0001_20260729_repr_extract_embeddings"
