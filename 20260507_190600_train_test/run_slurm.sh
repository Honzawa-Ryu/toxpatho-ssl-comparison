#!/bin/bash
#SBATCH --job-name=20260507_190600_train_test
#SBATCH --partition=large-andre01
#SBATCH --output=outputs/20260507_190600_train_test/%j_slurm.out
#SBATCH --error=outputs/20260507_190600_train_test/%j_slurm.out
#SBATCH --nodes=1
#SBATCH --gpus=1
...
export EXP_NAME="20260507_190600_train_test"
ENV_FILE="${PROJECT_ROOT}/.env"
WORKSPACE_OUTPUT_DIR="${PROJECT_ROOT}/outputs/20260507_190600_train_test"
