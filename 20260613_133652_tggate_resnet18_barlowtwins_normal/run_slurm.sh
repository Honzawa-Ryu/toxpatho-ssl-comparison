#!/bin/bash
#SBATCH --job-name=20260613_133652_tggate_resnet18_barlowtwins_normal
#SBATCH --partition=x-large-andre01
#SBATCH --time=12:00:00
#SBATCH --output=outputs/20260613_133652_tggate_resnet18_barlowtwins_normal/%j_slurm.out
#SBATCH --error=outputs/20260613_133652_tggate_resnet18_barlowtwins_normal/%j_slurm.out
#SBATCH --nodes=1
#SBATCH --gpus=1
...
export EXP_NAME="20260613_133652_tggate_resnet18_barlowtwins_normal"
ENV_FILE="${PROJECT_ROOT}/.env"
WORKSPACE_OUTPUT_DIR="${PROJECT_ROOT}/outputs/20260613_133652_tggate_resnet18_barlowtwins_normal"
